<?php
<object class="manage_foreis_edit" name="manage_foreis_edit" baseclass="page">
  ...
  <property name="Name">manage_foreis_edit</property>
  <property name="TemplateEngine">SmartyTemplate</property>
  <property name="TemplateFilename">manage_foreis_edit.htm</property>
  <property name="Width">800</property>
  <property name="OnBeforeShow">manage_foreis_editBeforeShow</property>
  <property name="OnCreate">manage_foreis_editCreate</property>
  <object class="Panel" name="Panel1" >
    ...
    <object class="Button" name="btnPost" >
      ...
      <property name="jsOnClick">btnPostJSClick</property>
    </object>
    <object class="Label" name="Label14" >
      <property name="Caption"><![CDATA[Ενημέρωση Φορέα:]]></property>
      <property name="Font">
    ...
    <object class="HiddenField" name="table_name" >
      <property name="Height">18</property>
      <property name="Left">576</property>
      <property name="Name">table_name</property>
    ...
    <object class="Label" name="Label3" >
      <property name="Caption"><![CDATA[Eπιλέξτε τον  Φορέα (Πατέρα) που εποπτεύει αυτόν που θα καταχωρίσετε:]]></property>
  ...
  <object class="Button" name="btnAdd" >
    <property name="Caption"><![CDATA[Νέος Φορέας]]></property>
    <property name="Height">25</property>
  ...
  <object class="Label" name="Label_searchterms" >
    <property name="Caption"><![CDATA[Αναζήτηση σε όνομα ή ID :]]></property>
    <property name="Height">13</property>
  ...
  <object class="Datasource" name="dsRepeater" >
    ...
    <property name="Dataset">apAuth.ForeisAllView</property>
