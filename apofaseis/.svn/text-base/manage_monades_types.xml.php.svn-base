<?php
<object class="manage_monades_types" name="manage_monades_types" baseclass="page">
  ...
  <property name="Name">manage_monades_types</property>
  <property name="TemplateEngine">SmartyTemplate</property>
  <property name="TemplateFilename">manage_monades_types.htm</property>
  <property name="Width">800</property>
  <property name="OnBeforeShow">manage_monades_typesBeforeShow</property>
  <property name="OnCreate">manage_monades_typesCreate</property>
  <property name="jsOnSubmit">manage_monades_typesJSSubmit</property>
  <object class="Panel" name="Panel1" >
    ...
    <object class="Label" name="Label14" >
      <property name="Caption"><![CDATA[Ενημέρωση Τύπου Μονάδας:]]></property>
      <property name="Font">
    ...
    <object class="Label" name="Label9" >
      <property name="Caption"><![CDATA[Όνομα Τύπου Μονάδας:]]></property>
      <property name="Height">13</property>
    ...
    <object class="ComboBox" name="field_type" >
      <property name="Height">18</property>
      <property name="Items"><![CDATA[a:2:{i:1;s:20:"Υπουργείο και γενικά";i:2;s:13:"Γενικός Τύπος";}]]></property>
      <property name="Left">183</property>
      <property name="Name">field_type</property>
      <property name="Top">96</property>
  ...
  <object class="Button" name="btnAdd" >
    <property name="Caption"><![CDATA[Νέος Τύπος Μονάδας]]></property>
    <property name="Height">25</property>
  ...
  <object class="Datasource" name="dsRepeater" >
    ...
    <property name="Dataset">apAuth.MonadesTypesTable</property>
