...
class DHTML_Calendar {
    ...
    function make_input_field($cal_options = array(), $field_attributes = array(), $height=-1) {
        $id = $this->_gen_id();
        ...
        $h="";
        if ($height<>-1) $h=" width=\"$height\" height=\"$height\" ";
        echo '<a href="#" id="'. $this->_trigger_id($id) . '">' .
            '<img align="absmiddle" border="0" src="' . $this->calendar_lib_path . 'img.gif" alt="" '.$h.' /></a></td></tr></table>';
    ...
    function _make_js_hash($array) {
        ...
        while (list($key, $val) = each($array))
        {
                ...
                else if ($key=='onUpdate') $jstr .= ',' . $key . ':' . $val;
                else
                {
